...
class Chronos2ForForecasting(nn.Module, VllmModelForPooling):
    ...
    def predict(
        ...
        **kwargs,
        ...
        """
        Generate formatted quantile forecasts (default method for vLLM API).
        
        This method calls predict_quantiles() internally to provide properly formatted
        output for the vLLM serving API while maintaining compatibility.
